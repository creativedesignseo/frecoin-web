...
- **Do not modify** `.env*`, secret files, hosting config (`netlify.toml`,
  `.netlify/`, the deploy workflow), `public/send-form.php`, or
  migration history without an explicit instruction naming that
  specific file.
